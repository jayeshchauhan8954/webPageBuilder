...
export class CodeEditor {
    ...
    pfx: grapesjs.EditorConfig
    opts: Required<Options>
    canvas: HTMLCanvasElement
    panelViews: HTMLElement[]
    isShowing: boolean

    htmlCodeEditor?: string
    codePanel?: HTMLDivElement
    cssCodeEditor?: string
    previousCss?: string

    constructor(editor: grapesjs.Editor, opts: Required<Options>) {
        this.editor = editor;
        this.$ = editor.$;
    ...
    buildSection(type: string, codeViewer) {
        const { $, pfx, opts } = this;
